...
/***/ "./node_modules/babel-loader/lib/index.js?!./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/coreui/src/views/media/Media.vue?vue&type=template&id=268102e9&":
/*!***********************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib??ref--4-0!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--6!./node_modules/vue-loader/lib??vue-loader-options!./resources/coreui/src/views/media/Media.vue?vue&type=template&id=268102e9& ***!
  \***********************************************************************************************************************************************************************************************************************************************/
...
var render = function render() {
  ...
  return _c("CRow", [_c("CCol", {
  ...
  }, [_c("CCard", [_c("CCardBody", [_c("h4", [_vm._v("Media")]), _vm._v(" "), _vm.parentFolder != "disable" ? _c("CButton", {
    attrs: {
      color: "primary"
    },
    on: {
    ...
    attrs: {
      content: _vm.$options.levelUpIcon
    }
  }), _vm._v("\n              Return\n          ")], 1) : _vm._e(), _vm._v(" "), _c("CButton", {
    attrs: {
      color: "primary"
    },
    on: {
    ...
    scopedSlots: _vm._u([{
      ...
      fn: function fn(_ref) {
        var item = _ref.item;
        return [item.type == "folder" ? _c("td", {
          staticClass: "click-file",
          on: {
            click: function click($event) {
              return _vm.clickOnElement(item.id, item.type);
            }
          }
        }, [_c("CIcon", {
          attrs: {
      ...
      fn: function fn(_ref2) {
        ...
        return [_c("td", [_c("CButton", {
          ...
          on: {
            click: function click($event) {
              return _vm.renameOpenForm(item.id, item.type);
            }
          }
        }, [_vm._v("\n                      Rename\n                  ")]), _vm._v(" "), _c("CButton", {
          attrs: {
          ...
          on: {
            click: function click($event) {
              return _vm.moveOpenForm(item.id, item.type, item.name);
            }
          }
        }, [_vm._v("\n                      Move\n                  ")]), _vm._v(" "), item.type == "file" ? _c("CButton", {
          attrs: {
            color: "primary"
          },
          on: {
        ...
        }, [_vm._v("\n                      Copy\n                  ")]) : _vm._e(), _vm._v(" "), item.type == "file" ? _c("CButton", {
          attrs: {
            color: "primary"
          },
          on: {
            click: function click($event) {
              return _vm.downloadFile(item.id, item.name);
            }
          }
        }, [_vm._v("\n                      Download\n                  ")]) : _vm._e(), _vm._v(" "), item.type == "file" && item.mime.includes("image/") ? _c("CButton", {
          attrs: {
            color: "success"
          },
          on: {
            click: function click($event) {
              return _vm.openCroppFileModal(item.id);
            }
          }
        }, [_vm._v("\n                      Cropp\n                  ")]) : _vm._e(), _vm._v(" "), item.type == "file" ? _c("CButton", {
          attrs: {
          ...
          on: {
            click: function click($event) {
              return _vm.openDeleteDialog(item.id, item.type, item.name);
            }
          }
        }, [_vm._v("\n                      Delete\n                  ")]) : _vm._e()], 1)];
      }
    }])
  })], 1)], 1)], 1)], 1), _vm._v(" "), _c("CCol", {
    attrs: {
      col: "7",
      xl: "7"
    }
  ...
  }, [_vm.rightCard == "fileInfo" ? _c("CCard", [_c("CCardBody", [_c("CDataTable", {
    attrs: {
      items: _vm.fileInfo,
      fields: _vm.fileInfoHeader
    }
  })], 1)], 1) : _vm._e(), _vm._v(" "), _vm.rightCard == "renameFolder" ? _c("CCard", [_c("CCardBody", [_c("CInput", {
    attrs: {
      type: "text",
      label: "New name",
  ...
  }, [_vm._v("\n              Cancel\n          ")])], 1)], 1) : _vm._e(), _vm._v(" "), _vm.rightCard == "renameFile" ? _c("CCard", [_c("CCardBody", [_c("CInput", {
    attrs: {
      type: _vm.text,
      label: "New name",
      placeholder: "Folder name"
  ...
  }, [_vm._v("\n              Cancel\n          ")])], 1)], 1) : _vm._e(), _vm._v(" "), _vm.rightCard == "moveFolder" ? _c("CCard", [_c("CCardBody", [_c("h4", [_vm._v('Move folder "' + _vm._s(_vm.moveObjectName) + '"')]), _vm._v(" "), _vm.parentFolder != "disable" ? _c("CInputRadio", {
    attrs: {
      label: "Move Up",
      type: "radio",
  ...
  }) : _vm._e(), _vm._v(" "), _vm._l(_vm.selectFolderArray, function (item) {
  ...
  }, [_vm._v("\n              Cancel\n          ")])], 2)], 1) : _vm._e(), _vm._v(" "), _vm.rightCard == "moveFile" ? _c("CCard", [_c("CCardBody", [_c("h4", [_vm._v('Move file "' + _vm._s(_vm.moveObjectName) + '"')]), _vm._v(" "), _vm.parentFolder != "disable" ? _c("CInputRadio", {
    attrs: {
      label: "Move Up",
      type: "radio",
      name: "selectFolderForFolder"
  ...
  }) : _vm._e(), _vm._v(" "), _vm._l(_vm.mediaFolders, function (item) {
    return _c("CInputRadio", {
      key: item.id,
      attrs: {
        label: item.name,
  ...
  }, [_vm._v("\n              Cancel\n          ")])], 2)], 1) : _vm._e()], 1)], 1), _vm._v(" "), _c("CModal", {
    attrs: {
    ...
    scopedSlots: _vm._u([{
      ...
      fn: function fn() {
        ...
        }, [_vm._v("Cancel")]), _vm._v(" "), _c("CButton", {
          attrs: {
            color: "danger"
          },
          on: {
            click: _vm.deleteFolder
          }
        }, [_vm._v("Delete")])];
      },
      proxy: true
    }])
  }, [_vm._v('\n      Are you sure to delete a folder named "' + _vm._s(_vm.moveObjectName) + '"?\n    ')]), _vm._v(" "), _c("CModal", {
    attrs: {
  ...
  }, [_vm._v('\n      Are you sure to delete a file named "' + _vm._s(_vm.moveObjectName) + '"?\n    ')]), _vm._v(" "), _c("CModal", {
    attrs: {
      show: _vm.croppModal,
      centered: true,
      title: "Cropp image",
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_babel_loader_lib_index_js_ref_4_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ref_6_node_modules_vue_loader_lib_index_js_vue_loader_options_Media_vue_vue_type_template_id_268102e9___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/babel-loader/lib??ref--4-0!../../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??ref--6!../../../../../node_modules/vue-loader/lib??vue-loader-options!./Media.vue?vue&type=template&id=268102e9& */ "./node_modules/babel-loader/lib/index.js?!./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/coreui/src/views/media/Media.vue?vue&type=template&id=268102e9&");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "render", function() { return _node_modules_babel_loader_lib_index_js_ref_4_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ref_6_node_modules_vue_loader_lib_index_js_vue_loader_options_Media_vue_vue_type_template_id_268102e9___WEBPACK_IMPORTED_MODULE_0__["render"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "staticRenderFns", function() { return _node_modules_babel_loader_lib_index_js_ref_4_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ref_6_node_modules_vue_loader_lib_index_js_vue_loader_options_Media_vue_vue_type_template_id_268102e9___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"]; });
